...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Create the train/test file for compound-viral protein interactions with embedding for compounds + embeddings for proteins')
    parser.add_argument('input1', help='The train/test compound-viral interactions file for end-to-end deep learning')
    parser.add_argument('input2', help='File containging autoencoder embedding for compounds to be trained/tested')
    parser.add_argument('input3', help='File containging fingerprints for compounds to be trained/tested')
    parser.add_argument('input4', help='File containging autoencoder for train/test vrial proteins')
